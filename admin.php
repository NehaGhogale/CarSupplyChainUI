<?php include('templates/_header.php'); ?>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-6 col-sm-6 col-xs-12">
                        <div class="white-box">
                            <h3 class="box-title">Product Supplychain Contract Address <i class="fa fa-qrcode fa-2x text-info"></i></h3>
                            <ul class="list-inline two-part">
                                <li class="text-right" id="productSupplychainContractAddress">0x0000000000000000000000000000000000000000</li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-lg-6 col-sm-6 col-xs-12">
                                ...
                                <table class="table product-overview">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><span class="label label-info font-weight-100">QUALITY_INSPECTOR</span></td>
                                        </tr>
                                         <tr>
                                            <td>Manufacturer</td>
                                        ...
                                        <tr>
                                            <td>DeliveryHub</td>
                                            <td><span class="label label-primary font-weight-100">DELIVERY_HUB</span></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
