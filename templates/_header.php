...
<head>
    ...
    <!-- <link rel="icon" type="image/png" sizes="16x16" href="plugins/images/t-systemsLogo.png"> -->
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top m-b-0 sidebar">
            <div class="navbar-header"> 
                <div class="top-left-part"><a class="logo" href="index.php"><b><!-- img src="plugins/images/t-systemsLogo.png" alt="home" / --></b><span class="hidden-xs"> Supply Chain </span></a></div>
            </div>
        </nav>
        <!-- Left navbar-header -->
